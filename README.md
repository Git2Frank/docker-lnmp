...
没有安装 Docker 的同学移步 [安装教程](https://github.com/Git2Frank/docker-lnmp#安装-docker-及相关工具)

    cd ~/
    git clone https://github.com/Git2Frank/docker-lnmp.git
...
中科大镜像源：http://mirrors.ustc.edu.cn/help/dockerhub.html
